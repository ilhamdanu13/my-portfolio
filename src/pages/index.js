  ...
  return (
    <>
      ...
      <main className="bg-[#091427] font-poppins">
            ...
            >
              <div className="md:w-2/3">
                ...
                <p className="text-[#868490] lg:text-xl lg:leading-9 mb-9 md:mb-5 lg:mb-9 md:w-5/6 lg:w-2/3">
                  An adaptive and fast learner Fullstack Web Developer. Now
                  using React, React Native, Express and other Javascript
                  frameworks to develop web and mobile apps. Have made several
                  projects such as an e-wallet web app using Next, ticket movie
                  web & mobile app using React, and more. Also can work well as
                  part of team, hardworker and eager to learn.
                </p>
          ...
          <div className="flex flex-col gap-y-4 md:gap-y-8">
            <div className="bg-white/10 p-4 md:p-8 flex flex-col md:flex-row md:items-center gap-y-4 gap-x-8  rounded z-50">
              ...
              <div className="text-white flex flex-col justify-center gap-y-2">
                <span className="text-white text-2xl w-max">
                  Web Development
                </span>
        ...
        <section
          id="portfolios"
          className="container mx-auto px-4 mb-8 md:mb-16 lg:mb-32 relative"
        >
          <div className="">
            <div className="flex flex-col justify-center items-center gap-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 text-white">
              ...
              <Link
                href={"https://uol-wattenhouse.com.sg/"}
                target="_blank"
                className="flex flex-col items-center gap-y-4 bg-white/10 z-50 p-4 lg:p-8 rounded"
              >
                <Image
        ...
        <section className="relative">
          <div className="absolute top-0 z-0">
            <Image src={Gradient4} alt="gradient" className="object-cover" />
          </div>
        </section>
          ...
          <div className="container mx-auto lg:px-24 md:px-16 px-4 mb-12 md:mb-32 z-50 relative">
            <div className="flex flex-col-reverse md:flex-row justify-between items-center">
              <div className="md:w-1/2 space-y-4 md:space-y-20">
                ...
                <div className="flex items-center gap-x-10">
                  <span className="text-xl text-[#F8E7A1] ">Chat me</span>
                  <BsArrowRight className="w-6 h-6 text-[#F8E7A1]" />
                </div>
              </div>
              <div className="">
        ...
        <Footer />
        <TawkMessengerReact
          propertyId="64c0982e94cf5d49dc6673f7"
          widgetId="1h6854tt5"
        />
      </main>
    </>
